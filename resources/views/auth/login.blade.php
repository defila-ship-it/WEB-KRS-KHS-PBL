...
<div class="login-page">
    <div class="login-card">
        <div class="login-logo">
            <div class="logo-icon">POLI<br>BATAM</div>
            <div>
                <div class="logo-text">POLIBATAM</div>
                <div class="logo-sub">Politeknik Negeri Batam</div>
            </div>
        </div>
            ...
            <div class="form-group">
                ...
                <div class="input-wrap">
                    <input class="form-control" type="password" name="password"
                           id="loginPass" placeholder="Masukkan password">
...
function togglePass() {
    ...
    if (p.type === 'password') { p.type='text'; i.className='fas fa-eye'; }
    else { p.type='password'; i.className='fas fa-eye-slash'; }
}
</script>
</body>
</html>